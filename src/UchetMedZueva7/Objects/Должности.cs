...
namespace IIS.UchetMedZueva7
{
    ...
    public class Должности : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Подразделение.
        /// </summary>
        // *** Start programmer edit section *** (Должности.Подразделение CustomAttributes)

        // *** End programmer edit section *** (Должности.Подразделение CustomAttributes)
        public virtual IIS.UchetMedZueva7.Подразделения Подразделение
        {
            get
            {
                // *** Start programmer edit section *** (Должности.Подразделение Get start)

                // *** End programmer edit section *** (Должности.Подразделение Get start)
                IIS.UchetMedZueva7.Подразделения result = this.fПодразделение;
                // *** Start programmer edit section *** (Должности.Подразделение Get end)

                // *** End programmer edit section *** (Должности.Подразделение Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Должности.Подразделение Set start)

                // *** End programmer edit section *** (Должности.Подразделение Set start)
                this.fПодразделение = value;
                // *** Start programmer edit section *** (Должности.Подразделение Set end)

                // *** End programmer edit section *** (Должности.Подразделение Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДолжностиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностиE", typeof(IIS.UchetMedZueva7.Должности));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДолжностиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностиL", typeof(IIS.UchetMedZueva7.Должности));
                }
            }
        }
    }
