...
moduleForModel('i-i-s-uchet-med-zueva7-список-на-медосм', 'Unit | Serializer | i-i-s-uchet-med-zueva7-список-на-медосм', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-med-zueva7-список-на-медосм',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
