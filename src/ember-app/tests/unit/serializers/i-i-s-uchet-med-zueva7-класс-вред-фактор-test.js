...
moduleForModel('i-i-s-uchet-med-zueva7-класс-вред-фактор', 'Unit | Serializer | i-i-s-uchet-med-zueva7-класс-вред-фактор', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-med-zueva7-класс-вред-фактор',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
