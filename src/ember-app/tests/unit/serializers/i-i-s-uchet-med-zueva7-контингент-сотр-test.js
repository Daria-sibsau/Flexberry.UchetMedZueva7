...
moduleForModel('i-i-s-uchet-med-zueva7-контингент-сотр', 'Unit | Serializer | i-i-s-uchet-med-zueva7-контингент-сотр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-med-zueva7-контингент-сотр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
